...
public class AttendanceDetailsActivity extends Activity {
	...
	{		
		Spinner ssubject = (Spinner) findViewById(R.id.ssubject);
		Intent intent = new Intent(AttendanceDetailsActivity.this, AttendanceActivity.class);
		intent.putExtra(AttendanceActivity.CLASS_EXTRA, cursorCLASS.getString(cursorCLASS.getColumnIndex("NAME")));
		intent.putExtra(AttendanceActivity.DATE_EXTRA, date.getText().toString());
		intent.putExtra(AttendanceActivity.SUBJECT_EXTRA, cursorSUBJECT.getString(cursorSUBJECT.getColumnIndex("FNAME")));
